...
g.V().hasLabel('person', 'software').count() <11>
----
...
<11> Find all vertices containing the label "person" or "software". To require all specified labels be present on a multi-label
